...
export default {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.3cc4a4f9.mjs').then(interopDefault),
  "pages/contact.vue": () => import('./_nuxt/contact-styles.981acc45.mjs').then(interopDefault),
